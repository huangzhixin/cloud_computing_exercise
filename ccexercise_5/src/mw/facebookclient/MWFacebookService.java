 ...
 * 
 */
@WebServiceClient(name = "MWFacebookService", targetNamespace = "http://facebook.mw/", wsdlLocation = "http://ec2-52-16-173-106.eu-west-1.compute.amazonaws.com:18081/MWFacebookServer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://ec2-52-16-173-106.eu-west-1.compute.amazonaws.com:18081/MWFacebookServer?wsdl");
